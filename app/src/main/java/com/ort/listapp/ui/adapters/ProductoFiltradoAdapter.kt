...
class ProductoFiltradoAdapter(
    var productos: List<Producto>,
    val context: Context,
    var onClick: (Producto) -> Unit
) : RecyclerView.Adapter<ProductoFiltradoAdapter.ProductoHolder>() {
    ...
    class ProductoHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        fun setPrecio(precio: Double) {
            ...
            txtPrecio.text = "$ ${precio.toInt()}"
        }

        fun getCard(): CardView {
            return view.findViewById(R.id.card_item_filtrado)
        }
